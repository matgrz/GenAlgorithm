...
{
public:
    RouletteSelector(int killCountPercentage);
...
private:
    ...
    std::set<int> getIndexesToKill(const std::vector<float>& distributions, const int) const;
